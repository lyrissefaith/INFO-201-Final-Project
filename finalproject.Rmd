...
mutateWide <- obesity_wide %>%
  filter(na.rm = TRUE) %>%
  mutate(obesity_wide, ob_growth = ((obesity_wide$"2022" - obesity_wide$'2015')/(obesity_wide$'2015')), na.rm = TRUE) %>%
  mutate(population_wide, pop_growth = ((population_wide$"2022" - population_wide$'2015')/(population_wide$'2015')), na.rm = TRUE) %>%
...
|  -------- | :------: | :----:       | :----:   |
|Minnesota   |   0.326   |  0.0429    | True |
|Utah   |   0.294   |  0.134    | True |
|Montana   |   0.284   |  0.0897    | True |
|Ohio   |   0.248   |  0.0119      | True |
|Wisconsin   |   0.238   |  0.0228    | True |

**Lowest 5 obesity growth rate:**

|     State | ob_growth | pop_growth |Obesity > Population growth | 
|  -------- | :------: | :----:   | :----:   |
|District of Columbia   |   -0.0271   |  -0.00533    |False |
|Alabama   |   0.00562   |  0.0457    |False |
|Illinois   |   0.00649   |  -0.0215    |True |
|Oregon   |   0.0133   |  0.0559      |False |
|Kansas   |   0.0146   |  0.00967    |True |

**Top 5 population growth rate:**

|     State | pop_growth | ob_growth |Obesity > Population growth | 
|  -------- | :------: | :----:   | :----:   |
|Idaho      |  0.174    |  0.168    |False |
|Utah    |  0.134    |  0.294    |True |
|Nevada    |  0.108    |  0.195    |True |
|Florida |  0.101    |  0.209    |True |
|Texas     |  0.0932    |  0.0617    |False |

**Lowest 5 population growth rate:**

|     State | pop_growth | ob_growth |Obesity > Population growth | 
|  -------- | :------: | :----:   |:----:   |
|West Virginia    |  -0.0363 |  0.169    |True |
|Illinois  |  -0.0215   |  0.00649    |True |
|Mississippi    |  -0.0162    |  0.0393    |True |
|Louisiana |  -0.0159    |  0.0387    |True |
|Wyoming     |  -0.00723    |  0.179    |True |
